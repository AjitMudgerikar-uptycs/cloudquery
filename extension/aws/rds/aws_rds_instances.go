...
func ListInstanceColumns() []table.ColumnDefinition {
	return []table.ColumnDefinition{
		table.TextColumn("allocated_storage"),
		...
		table.TextColumn("backup_retention_period"),
		...
		table.TextColumn("db_instance_port"),
		...
		// table.TextColumn("endpoint_port"),
		...
		// table.TextColumn("instance_create_time_ext"),
		// table.TextColumn("instance_create_time_loc"),
		// table.TextColumn("instance_create_time_loc_cache_end"),
		// table.TextColumn("instance_create_time_loc_cache_start"),
		...
		// table.TextColumn("instance_create_time_loc_cache_zone_offset"),
		...
		// table.TextColumn("instance_create_time_loc_zone_offset"),
		// table.TextColumn("instance_create_time_wall"),
		table.TextColumn("iops"),
		table.TextColumn("kms_key_id"),
		table.TextColumn("latest_restorable_time"),
		// table.TextColumn("latest_restorable_time_ext"),
		// table.TextColumn("latest_restorable_time_loc"),
		// table.TextColumn("latest_restorable_time_loc_cache_end"),
		// table.TextColumn("latest_restorable_time_loc_cache_start"),
		...
		// table.TextColumn("latest_restorable_time_loc_cache_zone_offset"),
		...
		// table.TextColumn("latest_restorable_time_loc_zone_offset"),
		// table.TextColumn("latest_restorable_time_wall"),
		...
		// table.TextColumn("listener_endpoint_port"),
		table.TextColumn("master_username"),
		table.TextColumn("max_allocated_storage"),
		table.TextColumn("monitoring_interval"),
		...
		// table.TextColumn("pending_modified_values_allocated_storage"),
		// table.TextColumn("pending_modified_values_backup_retention_period"),
		...
		// table.TextColumn("pending_modified_values_iops"),
		...
		// table.TextColumn("pending_modified_values_port"),
		...
		table.TextColumn("performance_insights_retention_period"),
		...
		table.TextColumn("promotion_tier"),
